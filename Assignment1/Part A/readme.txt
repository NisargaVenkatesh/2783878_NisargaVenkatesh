...
This styling is done using the hover function in the styles.css file.
The second section is the Education section which is divided from the first using the <hr> tag. 
It consists of the educational details in a list format.
The third and fourth section consists of the work experience and the technical skills of the candidate. 
They are displayed in table format. When the user hovers on the text of the table the color changes.
The fifth section displays the hobbies of the candidate. A hyperlink is provided which redirects the user to the hobbies.html page which lists the hobbies of candidate.
The last section is a contact me section which has a image button. On clicking the Contact Me button the user gets redirected to the contacts.html page.
The Contact.html page consists of the address of candiate and a form which asks for users first name, last name and email.
When user clicks on the submit button the data is mailed to an email address.
